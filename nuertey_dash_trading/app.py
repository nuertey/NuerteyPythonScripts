    ...
    app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
        ...
        html.Div(                    
            children=[
                ...
                html.P('[5] Within the quotes table, good Buys, that is, \"Ask prices less than or equal to the current VWAP\" will change color from ... to green.'),
                html.P('[6] Within the quotes table, good Sells, that is, \"Bid prices greater than or equal to the current VWAP\" will change color from ... to red.'),
