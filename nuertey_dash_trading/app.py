...
# to visualize Nuertey's VWAP Stock Trading Algorithm in action.
#
# @note [1] Incoming stock trades as captured in the PostgreSQL database
#           are displayed to the user.
#
#       [2] Incoming stock quotes as captured in the PostgreSQL database
#           are displayed to the user.
#
#       [3] Outgoing customer stock orders generated by the VWAP algorithm
#           and captured in the PostgreSQL database are displayed to the
#           user.
#
#       [4] Within the quotes table, good Buys, that is, "Ask prices less
#           than or equal to the current VWAP" will change color from ...
#           to green.
#
#       [5] Within the quotes table, good Sells, that is, "Bid prices 
#           greater than or equal to the current VWAP" will change color
#           from ... to red.
#
#       [6] The rolling VWAP as calculated and captured in the PostgreSQL 
#           database is plotted and continuously updated for the user.
#               
# @warning  None
#
