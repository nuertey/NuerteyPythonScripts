    ...
    app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
        ...
        html.Div(                    
            children=[
                ...
                html.P(children=[html.Strong('[1] Chose a country from the drop down list for the current news headlines in that country to be displayed to the user. Clicking on each news item headline will open a tab for that news item from the news agency of concern.')]),
                html.P(children=[html.Strong('[2] Incoming stock trades as captured in the PostgreSQL database are displayed to the user.')]),
                html.P(children=[html.Strong('[3] Incoming stock quotes as captured in the PostgreSQL database are displayed to the user.')]),
                html.P(children=[html.Strong('[4] Outgoing customer stock orders generated by the VWAP algorithm and captured in the PostgreSQL database are displayed to the user.')]),
                html.P(children=[html.Strong('[5] Within the quotes table, good Buys, that is, \"Ask prices less than or equal to the current VWAP\" will change color from ... to green.')]),
                html.P(children=[html.Strong('[6] Within the quotes table, good Sells, that is, \"Bid prices greater than or equal to the current VWAP\" will change color from ... to red.')]),
                html.P(children=[html.Strong('[7] The rolling VWAP as calculated and captured in the PostgreSQL database will be plotted and continuously updated for the user.')]),
            ], 
